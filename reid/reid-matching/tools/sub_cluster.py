...
if __name__ == '__main__':
    ...
    config = 'aic_all.yml'
    print('{}/config/{}'.format(os.path.dirname(os.path.dirname(os.path.dirname(os.getcwd()))), config))
    # print(('{}/config/{}'.format(os.path.dirname( os.path.dirname(os.getcwd())), opt.cfg_file)))
    try:
        cfg.merge_from_file('{}/config/{}'.format(os.path.dirname(os.path.dirname(os.path.dirname(os.getcwd()))), sys.argv[1]))
    except:
        try:
            cfg.merge_from_file('{}/config/{}'.format(os.getcwd(), config))
        except:
