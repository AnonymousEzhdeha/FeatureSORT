...
class zone():
    def __init__(self):
        ...
        # b g 高速
        zones = {}
        zone_path = "/media/ezhdeha/B2CA8AACCA8A6C83/Pintel_Projects/DeepLearning/AIC21-MTMC/reid/reid-matching/tools/zone"
        ...
        for tracklet in mot_list:
            ...
            for f in frame_list:
                ...
                if new_zone_f>1:
                    ...
                    new_zone_f+=1
            # if (len(set(zone_list)) > 1 and len(zone_list) > 3):
            #     z = 2
            if back_tracklet:
                new_tracklet_dict = dict()
                pre_bbox = -1
